...
const samples: sampleData[] = [
        {
            ...
            "sampleURL": "https://www.bigcommerce.com/blog/catalyst-c15t-consent/",
        ...
        {
            "title": "Localizing a BigCommerce NextJS Storefront",
            "description": "Learn how to localize an ecommerce storefront, adding translations across static UI component text, dynamic data, and CMS-driven content",
            "url": "storefront-localization",
            "sampleURL": "https://docs.bigcommerce.com/developer/docs/storefront/catalyst/features/localization/multi-language/setup",
            "about": "This tutorial shows how to set up multi-language support in a BigCommerce NextJS storefront. The purpose was to teach how translations work across static UI component text, dynamic data, and CMS-driven content.\n\nOverall, this sample shows how I simplify cross-platform concepts into a repeatable, testable workflow. The lab uses sample data to help produce consistent results in a controlled environment. This helps keep the learning environment predictable and easy to understand while mirroring real-world storefront requirements. It also helps developers focus on performing each localization step without needing to debug unrelated issues.",
        ...
        },
        {
            ...
            "sampleURL": "https://www.bigcommerce.com/blog/api-route-handlers-catalyst/",
